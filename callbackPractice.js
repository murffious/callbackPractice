...
// If it does, return true using the callback, if not return false.
 ...
 function contains (arr, name, cb1) {
...
// and returns that user.
 ...
 function getUserById (arr, str, cb4) {
     for (var i= 0; i <arr.length; i++ )
      if (users[i].id === str) {
       return cb4(arr[i]);
      }
